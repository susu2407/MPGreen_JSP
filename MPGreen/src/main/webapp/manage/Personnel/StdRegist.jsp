...
<body>
    <main>
        ...
        <div class="managemain">
            ...
            <form class="register" >
                    <div>
                        <h4><img src="/minP01/images/bullet-h4.png" alt="h4">기본정보 입력</h4>
                    </div>

<!-- 테이블 시작 -->
                    <table class="basic">
                        <tr>
                            <th rowspan="4"><img src="/minP01/images/icon-avatar.png" alt=""></th>
                            <th class="mid">학번</th>
                            <td class="td-bd">
...
<!-- 학적정보 입력 -->
                    <div>
                        <h4><img src="/minP01/images/bullet-h4.png" alt="h4">학적정보 입력</h4>
                    </div>
