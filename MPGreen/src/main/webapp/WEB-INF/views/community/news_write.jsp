  ...
  <main>
    <div class="top-bar">
      <div class="top-bar-content">
        ...
        <img src="../images/bg-path-arrow.png" alt=">">
        <a href="${pageContext.request.contextPath}/community/news_write.do" class="sidebar-text">글쓰기</a>
      </div>
    </div>
    ...
    <section id="container">
      ...
      <div class="board">
        ...
        <div class="notice-wrap">
          <form class="write-form" action="${pageContext.request.contextPath}/community/news_write.do" method="post" enctype="multipart/form-data">
            <div class="form-row">
            ...
            <div class="form-actions">
              ...
              <a href="${pageContext.request.contextPath}/community/news.do" class="btn-cancel">취소</a>
            </div>
          </form>
        </div>
      </div>
