...
<body class="page-community qna-delete">
  <main>
    <!-- 상단 경로 -->
    <div class="top-bar">
      <div class="top-bar-content">
        ...
        <img src="../images/bg-path-arrow.png" alt=">">
        <a href="${pageContext.request.contextPath}/community/qna_delete.do?boardId=${board.boardId}" class="sidebar-text">질문 삭제</a>
      </div>
    </div>
    ...
    <section id="container">
      ...
      <!-- 본문 -->
      <div class="board">
        <div class="boardUpper"><h3 class="buText">질문 삭제</h3></div>
