...
<body class="page-community free-edit">
  <main>
    <!-- 상단 경로 -->
    <div class="top-bar">
      <div class="top-bar-content">
        ...
        <img src="../images/bg-path-arrow.png" alt=">">
        <!-- ❌ 기존: free_edit.do → ✅ 수정: edit.do -->
        <a href="${pageContext.request.contextPath}/community/edit.do?category=free&boardId=${board.boardId}" class="sidebar-text">글수정</a>
      </div>
    </div>
    ...
    <section id="container">
      ...
      <div class="board">
        <div class="boardUpper">
          <h3 class="buText">글수정</h3>
        </div>

        <div class="notice-wrap">
          <!-- ❌ 기존: free_edit.do → ✅ 수정: edit.do -->
			<form class="edit-form" action="${pageContext.request.contextPath}/community/edit.do?category=free" method="post">
			  ...
			  <div class="form-actions">
			    ...
			    <a href="${pageContext.request.contextPath}/community/view.do?category=free&boardId=${board.boardId}" class="btn-cancel">취소</a>
			  </div>
			</form>
