...
<body class="page-community news-delete">
  <main>
    <!-- 상단 경로 -->
    <div class="top-bar">
      <div class="top-bar-content">
        ...
        <img src="../images/bg-path-arrow.png" alt=">">
        <a href="${pageContext.request.contextPath}/community/news_delete.do?boardId=${board.boardId}" class="sidebar-text">글삭제</a>
      </div>
    </div>
